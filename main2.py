...
neo4j_uri = "neo4j+s://57b9e9fc.databases.neo4j.io"
neo4j_user = "neo4j"
neo4j_password = "knphzqreDy8dm4ju8_vtVqCXrValR4t9TplpJFYaT0E"
...
def add_movie(
    ...
    tx.run(
        "CREATE (m:Movie {title: $title, tmdb_id: $tmdb_id, released: $released, imdb_rating: $imdb_rating, movie_id: $movie_id, year: $year, imdb_id: $imdb_id, runtime: $runtime, countries: $countries, imdb_votes: $imdb_votes, url: $url, revenue: $revenue, plot: $plot, poster: $poster, budget: $budget, languages: $languages})",
        title=title,
        tmdb_id=tmdb_id,
        released=released,
